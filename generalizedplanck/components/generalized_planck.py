...
# from scipy.constants import pi as pi_const
# from scipy.constants import e as e_const
# from scipy.constants import m_e as m_const
...
class GeneralizedPlanck(Component):
    ...
    def update_component(self):
        param_list = []
        #print(self._aux_component_list)
    ...
    def planck(self, x, mu=None):
        ...
        if mu == None:
            ...
            m = mu
        #const = 2*pi_const/(h_const**3*c_const**2)
    ...
    def abs_coeff_tail_occupation(self, x):
        ...
        _f = self.abs_coeff_tail(x)*occupation
        return _f
